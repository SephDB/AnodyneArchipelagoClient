...
namespace AnodyneArchipelago
{
    public static class DeathHelper
    {
        public static string GetDeathReason()
        {
            ...
            {
                CheatzManager.DamageDealer => "cheated their way to death.",
                ...
                CircusFolks.DamageDealer => "got pummled by Arthur and Javiera.",
                ...
                FirePillar.DamageDealer => "got burned into a crisp.",
                ...
                SageBoss.LaserDamageDealer => "was taught a lesson by the Sage.",
                SageBoss.EdgeDamageDealer => "got in trouble with the Sage.",
                SageBoss.OrbDamageDealer => "got their orb pondered by the Sage.",
                ...
                Slasher.LongDamageDealer => "was cut horizontally by a Slasher.",
